...
# 安装 hmmlearn 命令：pip install -U --user hmmlearn
...
# 要将hmm_gmm.py文件以及training_data数据集和test_data数据集移动到my_hmm_gmm_speech_recognition-master目录下
# 不要放在 hmm_gmm_single_word 目录下
